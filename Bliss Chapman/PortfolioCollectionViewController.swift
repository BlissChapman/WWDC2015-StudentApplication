...
class PortfolioCollectionViewController: UICollectionViewController, SKStoreProductViewControllerDelegate {
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        if indexPath.item >= (self.collectionView!.numberOfItemsInSection(indexPath.section) - 1) {
            ...
            cell!.arrowIndicator.addTarget(self, action: "arrowTapped", forControlEvents: .TouchUpInside)
        ...
        case "Pocket Rain Gauge":
            ...
            cell!.moreInformationButton.addTarget(self, action: "openPRGInAppStore", forControlEvents: UIControlEvents.TouchUpInside)
        case "Cloud Inventory":
            cell!.moreInformationButton.addTarget(self, action: "viewCloudInventoryOnGithub", forControlEvents: .TouchUpInside)
        ...
        case "CocoaNuts Demos":
            cell!.moreInformationButton.addTarget(self, action: "viewMoreContent", forControlEvents: .TouchUpInside)
        ...
        var timer = NSTimer.scheduledTimerWithTimeInterval(5.0, target: self, selector: "pulseMoreInformationButton", userInfo: nil, repeats: false)
    ...
    func openPRGInAppStore() {
        ...
        var storeKitViewController = SKStoreProductViewController()
